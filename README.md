...
Run `motion_capture_landmark.py` to detect 33 landmarks of each video
  * centroid_x and centroid_y of each video frame are stored in folder `Motion_landmarks`
